...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        slideOutLeft: 'slideOutLeft 0.3s forwards',
        slideInRight: 'slideInRight 0.6s forwards',
        slideOutLeftRetorno: 'slideOutLeftRetorno 0.6s forwards',
        slideInRightRetorno: 'slideInRightRetorno 0.4s forwards',
        hideText: 'hideText 0.5s forwards',
        showText: 'showText 0.5s forwards',
